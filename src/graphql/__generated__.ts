...
export type SettingsCalculation_Filter = {
  readonly _and: InputMaybe<ReadonlyArray<InputMaybe<SettingsCalculation_Filter>>>;
  readonly _or: InputMaybe<ReadonlyArray<InputMaybe<SettingsCalculation_Filter>>>;
  readonly id: InputMaybe<Number_Filter_Operators>;
...
export type GetSettingsCalcQuery = { readonly __typename?: 'Query', readonly settingsCalculation: ReadonlyArray<{ readonly __typename?: 'settingsCalculation', readonly id: string, readonly type: string, readonly title: string, readonly min: number, readonly max: number, readonly step: number, readonly marks: any }> };
...
export const useGetSettingsCalcQuery = <
    ...
    return useQuery<GetSettingsCalcQuery, TError, TData>(
      variables === undefined ? ['GetSettingsCalc'] : ['GetSettingsCalc', variables],
      fetcher<GetSettingsCalcQuery, GetSettingsCalcQueryVariables>(GetSettingsCalcDocument, variables),
      options
    )};

useGetSettingsCalcQuery.getKey = (variables?: GetSettingsCalcQueryVariables) => variables === undefined ? ['GetSettingsCalc'] : ['GetSettingsCalc', variables];
...
export const useInfiniteGetSettingsCalcQuery = <
    ...
    return useInfiniteQuery<GetSettingsCalcQuery, TError, TData>(
      variables === undefined ? ['GetSettingsCalc.infinite'] : ['GetSettingsCalc.infinite', variables],
      (metaData) => fetcher<GetSettingsCalcQuery, GetSettingsCalcQueryVariables>(GetSettingsCalcDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    )};

useInfiniteGetSettingsCalcQuery.getKey = (variables?: GetSettingsCalcQueryVariables) => variables === undefined ? ['GetSettingsCalc.infinite'] : ['GetSettingsCalc.infinite', variables];


useGetSettingsCalcQuery.fetcher = (variables?: GetSettingsCalcQueryVariables) => fetcher<GetSettingsCalcQuery, GetSettingsCalcQueryVariables>(GetSettingsCalcDocument, variables);
